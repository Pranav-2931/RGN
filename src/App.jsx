...
const Footer = () => (
  <footer style={{ padding: '5rem 5%', textAlign: 'center', color: 'var(--text-muted)', borderTop: '1px solid var(--border-color)', background: '#000' }}>
    ...
    <p style={{ fontSize: '0.8rem', letterSpacing: '2px' }}>EST. 2026 | ROYAL GAMING NETWORK | NO LIMITS | V1.0.1</p>
  </footer>
)
...
const HeroDetails = () => {
  ...
  const heroData = {
    ...
    huhplayz: {
      name: 'HUHPLAYZ',
      role: 'HOMIE',
      bgUrl: 'https://media1.tenor.com/m/nrZw5rgDgywAAAAC/toji-manga-toji.gif',
      theme: { primary: '#a29bfe', secondary: '#2d3436' }, // Purple/Dark theme
      stats: [
        { label: 'Total Kills', value: '55,000+' },
        { label: 'Official Rank', value: '2-High Strong' },
        { label: 'Current Goal', value: 'Going for 1 low' }
      ]
    }
  }
