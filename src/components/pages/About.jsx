  ...
  <section id="about" className="about-section glass animate-fade-in" style={{ margin: '8rem 5%', padding: '5rem' }}>
    ...
    <div className="about-content">
      <div className="stat-grid">
        ...
        <div className="stat-item">
          <span className="stat-number">TOP 12</span>
          <span className="stat-label">Current Asia Rank</span>
        </div>
        <div className="stat-item">
      ...
      <div className="about-text" style={{ marginTop: '4rem', textAlign: 'center', maxWidth: '800px', marginInline: 'auto' }}>
        <p style={{ fontSize: '1.2rem', color: 'var(--text-muted)', lineHeight: '1.8' }}>
          RGN is not just a clan; it's a legacy. Currently ranked Top 12 in Asia, we continue our relentless climb to the summit. 
